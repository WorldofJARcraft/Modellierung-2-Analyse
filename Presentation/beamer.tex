...
\begin{acronym}[qualit.]  
	\acro{UG}{Unterrichtsgespräch} 
	\acro{sSa}{selbstständige Schülerarbeit}  
	\acro{GA}{Gruppenarbeit} 
	\acro{SV}{Schülervortrag}  
	\acro{LDE}{Lehrerdemonstrationsexperiment}  
	\acro{HA}{Hausaufgabe}
	\acro{EA}{Einzelarbeit}
	\acro{OHP}{Overheadprojektor}
	\acro{o.A.}{ohne Angabe}
	\acro{qualit.}{qualitatives}
\end{acronym}
\end{frame}
