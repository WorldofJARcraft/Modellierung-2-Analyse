...
\begin{frame}
\frametitle{Anwendungsfälle im Überblick}
\begin{acronym}[ablaufende Qualifikationen anzeigen]
...
\pause
\acro{ablaufende Qualifikationen anzeigen} {Läuft die Gültigkeit einer Qualifikation (z.B. Führerschein) ab, benachrichtigt das System den Personal- und den Ausbildungsbeauftragten.}
\end{acronym}
\end{frame}
\begin{frame}
\frametitle{Anwendungsfälle im Überblick}
